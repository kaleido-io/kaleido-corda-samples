...
import io.kaleido.samples.accountUtils.NewKeyForAccount;
import io.kaleido.samples.accountUtils.ShareAccountTo;
import net.corda.core.identity.PartyAndCertificate;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import io.kaleido.samples.accountUtils.CreateNewAccount;
...
public class AccountUtils {
    ...
    public Party getPartyFromId(String shareToId, CordaRPCOps rpcOps) {
        ...
        logger.info("Party: {}", shareTo.toString());
        return shareTo;
    }
